let subsetOptions = {
	...
	"construction-trade-tools": [
		...
		"Other Construction & Trade Tools",
	],
	electronics: [
		"Audio",
		"Cameras & Photography",
...
dropdownList.onchange = (ev) => {
	...
	let searchKeyword = dropdownList.value;

	for (let i = 0; i < subsetOptions.length; i++) {
		console.log(`not yet`);

		const currentArray = subsetOptions[key];
		if (currentArray.includes(searchKeyword)) {
			console.log(`Array found in ${key}: ${currentArray}`);
			break;
		}
	}
